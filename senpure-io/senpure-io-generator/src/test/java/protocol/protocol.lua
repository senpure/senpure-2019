--[[
author    senpure
version   2019-8-16 16:51:17

enum    : Sport.Gender          性别
enum    : Sport.ChatType        
enum    : Sport.ErrorType       错误信息类型
enum    : Data.EchoEnum         Echo中的一个enum

bean    : Sport.Player          运动员
bean    : Sport.Chat            聊天信息
bean    : Data.EchoBean         Echo中的一个bean
bean    : Data.Echo             

message : Sport.SCErrorMessage  1000500  
message : Data.CSEchoMessage    1000103  
message : Data.SCEchoMessage    1000104  
...
function Data.Echo:new()
    ...
    echo.sfixed32ValuesSerializedSize = 0;
    echo.sfixed64ValuesSerializedSize = 0;
    ...
    echo.sfixed32Values2SerializedSize = 0;
    echo.sfixed64Values2SerializedSize = 0;
